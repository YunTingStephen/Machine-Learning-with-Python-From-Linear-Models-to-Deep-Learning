...
class NeuralNetwork():
    ...
    def train(self, x1, x2, y):
        ...
        hidden_layer_weighted_input = self.input_to_hidden_weights.dot(input_values) #(3 by 1 matrix)
        ReLu_layer = np.vectorize(rectified_linear_unit)
        hidden_layer_activation =  ReLu_layer(hidden_layer_weighted_input)#(3 by 1 matrix)
        ...
        bias_gradients = np.multiply(hidden_layer_error, ReLU_derivative_vec(hidden_layer_weighted_input))# TODO
        
        hidden_to_output_weight_gradients = np.multiply(hidden_layer_activation, output_layer_error).transpose()# TODO
        input_to_hidden_weight_gradients = bias_gradients.dot(input_values.transpose()) # TODO
