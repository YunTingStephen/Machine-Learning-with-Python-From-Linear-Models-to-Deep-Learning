...
##print('Linear Regression test_error_1 =', run_linear_regression_on_MNIST(lambda_factor=1))
#print('Linear Regression test_error_0.1 =', run_linear_regression_on_MNIST(lambda_factor=0.1))
#print('Linear Regression test_error_0.01 =', run_linear_regression_on_MNIST(lambda_factor=0.01))
...
##print('softmax test_error(1)=', run_softmax_on_MNIST(temp_parameter=1.0))
#print('softmax test_error(0.01)=', run_softmax_on_MNIST(temp_parameter=0.5))
#print('softmax test_error(100)=', run_softmax_on_MNIST(temp_parameter=2.0))
...
##print("Softmax regression_test_error_mod3: ", run_softmax_on_MNIST_mod3(temp_parameter=1))
...
print("test_error_PCA: ", test_error_PCA)
